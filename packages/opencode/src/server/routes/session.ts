  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all LOWECODE sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific LOWECODE session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new LOWECODE session for interacting with AI assistants and managing conversations.",
